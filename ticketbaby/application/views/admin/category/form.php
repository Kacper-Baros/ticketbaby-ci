...
if (isset($result)) {
    ...
    $path = admin_url('category/update');
} else {
  $id = '';
  $parent_id = '';
    $path = admin_url('category/save');
}
?>

<a href="<?php echo admin_url('category'); ?>"><i class="fa fa-arrow-left leftarrow" aria-hidden="true">Back</i></a>
  ...
  ?>
                    ...
                    <div class="form-actions text-left "> 
                      ...
                      <input type="submit" value="<?php if(isset($result)){ echo "update"; }else{ echo "save"; } ?>" class="btn btn-primary"> 
                       <a href="<?php echo admin_url('category'); ?>" class="btn btn-danger">Cancel</a> 
