<div class="row">
    <div class="col-md-5">
        <div class="panel panel-default"> 
            ...
            <?php
            if (isset($seats)) {
                $url = admin_url('events/update_seats');
            } else {
                $url = admin_url('events/add_seats');
            }
            ?>
            ...
            <form class="form_edit" method="post" action="<?php echo $url; ?>">
                  ...
                  <div class="form-group">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" required id="Tickts_price-30" name="Tickts_price" class="form-control" placeholder="Tickets Price" value="<?php if(isset($seats)){ echo $seats->seat_charge;} ?>" />
                        </div>
                    </div>
                  </div>
                  <div class="form-group">
			   ...
			   <div class="form-group">
                ...
                <div class="form-actions text-left "> 
                    ...
                    <?php if(isset($seats)){ ?>
                          <input type="hidden" value="<?php echo $seats->id ?>" name="seat_id">
                    <?php } ?>
    ...
    <div class="col-md-7">
        ...
        <div class="panel panel-default"> 
            ...
            <a href="<?php echo admin_url('events/seats/'.$id) ?>" class="btn btn-success add_new_btn" type="button"><i class="icon-plus"></i>Add New</a>
            <div class="datatable"> 
                <table class="table table-bordered table-striped" id="EventSeatList"> 
                    <thead> 
                        <tr> 
                            ...
                            <th>Class</th>
							<th>Coupon</th>
                            <th class="actions-column">Action</i></th>
                        </tr> 
                    </thead> 
                    <tbody> 
                        <?php
                                ...
                                <td class="text-center"> 
                                    <div class="btn-group"> 
                                        ...
                                        <ul class="dropdown-menu icons-right dropdown-menu-right">
                                            <li><a href="<?php echo admin_url('events/view_seats_event/' . $s->id .'/'.$id)?>" data-toggle="modal" role="button"><i class="icon-eye"></i> View Detail</a></li>
                                            <li><a href="<?php echo admin_url('events/edit_seats/' . $s->id .'/'.$id)?>"><i class="icon-pencil2"></i> Edit </a></li>
                                            <li><a href="<?php echo admin_url('events/delete_seats/'.$s->id .'/'.$id) ?>" onclick="return confirm('Are your sure, want to delete?')"><i class="icon-remove4"></i> Remove </a></li>
                                        </ul> 
                                    </div> 
                                </td> 
                            </tr> 
