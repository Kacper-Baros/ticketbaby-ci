...
<html lang="en">
	...
	<?
				...
				foreach($ipcheck as $ips){ echo $ips->ip_address;
					if($ips->ip_address)
						$Access=1;
				}
				...
				if($IP=="82.25.12.169") 	$Access=1;
				if($IP=="213.205.251.255")	$Access=1;
				if($IP=="112.196.117.199")	$Access=1;
				if($IP=="103.41.36.17")		$Access=1;
				if($IP=="77.103.185.4")		$Access=1;
				if($IP=="109.151.227.242")	$Access=1;
