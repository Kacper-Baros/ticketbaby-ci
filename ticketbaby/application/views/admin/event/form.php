                ...
                <div class="tab-pane fade active in" id="content">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-4">
                                    <label>Featured Image:<br><i style="color:#ddd";>(Image Size: 220px X 235px)</i></label> 
                                ...
                                <div class="col-md-4">
                                    <label> Second Featured Image:<br><i style="color:#ddd";>(Image Size: 235px X 196px)</i></label> 
                                ...
                                <div class="col-md-4">
                                    <label>Event Seat Image:<br><i style="color:#ddd";>(Image Size: 1024px X 720px)</i></label> 
