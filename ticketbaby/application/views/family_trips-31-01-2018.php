      ...
      <div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-3 col-md-3">
            ...
            <!--<div class="brimpide_div"> <img src="<?php echo base_url('assets/images/briming.jpg') ?>" class="img-responsive" alt=""> <a href="#">Discounted Advanced Tickets on sale now</a> </div>
  <div class="ticket_div">
    <h4>Where are my tickets</h4>
    <a href="#"><img src="<?php echo base_url('assets/images/get_ticket.jpg') ?>" class="img-responsive" alt=""></a> </div>-->
