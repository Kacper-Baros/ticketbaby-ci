            ...
            <div class="header-bottom">
                ...
                <div class="header-right">
                    ...
                    <div class="bottom-qrcode">
						...
						///////////////////////////////////////////////////////////////////////////
						// Set up a link back for ticket validation and include in the QR code	//
						/////////////////////////////////////////////////////////////////////////
						
						$Evt=preg_replace('/\s+/','',$EvntNM);
						$ValidateCode="http://www.ticketbaby.co.uk?VT=".$Evt."-".$OrderID
						
						?>
                        
                        	<img id='barcode' src="https://api.qrserver.com/v1/create-qr-code/?data=<?php echo $ValidateCode.' OrderIDx: '.$OrderID.', Event Name: '.$EvntNM.', Customer Name: '.$CustomerName; ?>&amp;size=100x100" alt="" title="Scan Me" width="110" height="110" />
                            
                            
<?

//////////////////////////////////////////////////////
// QRSCANNER modification	April 2018				//
// Write out the eticket information to a file 		//
// So it can be validated with a QRScanner call		//
// To Ticketbaby.co.uk?VT=####						//
//////////////////////////////////////////////////////

$Filename="./eticketvalidations/".$Evt."-".$OrderID;
file_put_contents($Filename, $EventDate);
