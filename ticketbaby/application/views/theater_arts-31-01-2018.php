        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-6 col-md-6" style="padding: 0px;">
            ...
            <div id="owl-demo-2" class="custom_demo">
             ...
             ?>
              <div class="item">
                <div class="item_img"> <img src="<?php echo base_url('uploads/images/full/'.$ss->image) ?>" class="img-responsive imgg_club" alt="" style="height:150px;">
          ...
          <div class="col-xs-12 col-sm-3 col-md-3">
            ...
            <div class="where_ticket">
              ...
              <form method="POST" action="<?php echo base_url(); ?>new/front/sendmail">
