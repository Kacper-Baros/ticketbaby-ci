            ...
            <div class="local_venue">
              ...
              <div class="venue_list">
               ...
               <?php  
               		...
               		$letest = $this->db->get_where('tbl_events',array('recommended_carousel'=>'1 ORDER BY `tbl_events`.`id` DESC Limit 8 '))->result();
					foreach($letest as $val)
					{
					  $award_slug = $this->db->get_where('tbl_events',array('id'=>$val->id))->row()->slug;
				?>
                  <li> <a href="<?php  echo base_url($award_slug); ?>"><?php echo $val->venue; ?></a>
                 ...
                 <div class="tab-content">
                  <div role="tabpanel" class="tab-pane active" id="everyone">
                    <div class="row tab-list-wrapper">
                      <div class="fb-page" data-href="https://www.facebook.com/jalodara.jayesh.9/info?tab=page_info" data-width="250" data-height="200" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true" data-show-posts="true"><div class="fb-xfbml-parse-ignore"><blockquote cite="https://www.facebook.com/jalodara.jayesh.9/info?tab=page_info"><a href="https://www.facebook.com/jalodara.jayesh.9/info?tab=page_info">Bigshop</a></blockquote></div></div>
                    </div>
                    
                    <div class="more_link text-right"> <a href="#">More Artists ></a> </div>
                  </div>
                  <div role="tabpanel" class="tab-pane" id="friends" style="height:200px;overflow-y:scroll;">
                    <a class="twitter-timeline" href="https://twitter.com/Flipkart">Tweets by ticketbaby</a>
