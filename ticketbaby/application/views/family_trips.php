    ...
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <div class="row">
		  ...
		  <?php 
			$familytrips = $this->db->get_where('tbl_events',array('category_id'=>128))->result();
			if(empty($familytrips)){
		  ?>
          ...
          <div class="col-xs-12 col-sm-9 col-md-9" style="z-index: 9;">
            <ul id="listevents">
				<?php $filter = $city = $cityid = '';
					...
					if($filter=='OK'){
						$data = $this->db->order_by('id','DESC')->get_where('tbl_events',array('category_id'=>128, 'city'=>$city))->result();
					}
					else{
						$data = $this->db->order_by('id','DESC')->get_where('tbl_events',array('category_id'=>128))->result();
					}
					$eventCount=1;
					foreach($data as $val){
				?>
            ...
            <div class="where_ticket">
              ...
              <form method="POST" action="">
                ...
                <div class="multiselect form-group"><br>
					<?php 
					$cities = $this->db->get_where('tbl_events',array('category_id'=>128))->result();
					$cityArr = array();
					foreach($cities as $val){
