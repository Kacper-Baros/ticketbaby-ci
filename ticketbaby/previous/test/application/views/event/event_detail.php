 ...
 <div class="container-fluid content-bg">
            ...
            <div class="col-md-12">
                <div class="col-md-4">
                    <div class="main-thumb">
                        <img src="<?=base_url()?>assets/upload/event/thumb/<?php echo $event["thumb1_standard_carousel"]; ?>" />
                    </div>
                </div>
                <div class="col-md-8">
            ...
            <div class="col-md-5 col-sm-4 left-sidebar">
                ...
                <div class="table-only">
                    ...
                    <ul>
                        ...
                        <label class="col-md-12 col-sm-12 col-xs-12"> 
                            <strong class="col-md-4 col-sm-5 col-xs-3">Type</strong>
                            <strong class="col-md-3 col-sm-3 col-xs-5" >Price</strong>
                            <strong class="col-md-3 col-sm-2 col-xs-4">Available</strong>
                            <strong class="col-md-2 col-sm-2 col-xs-4"></strong>
                        </label>
                        </li>
                        ...
                        <li class="row">
                        	...
                        	<label class="col-md-4 col-sm-5 col-xs-3"> 
                            ...
                            <label class="col-md-3 col-sm-2 col-xs-4">
                            	<em><?php echo $avaialble_table;  ?></em>
                            </label>
                ...
                <div class="table-only">
                    ...
                    <ul>
                        <li class="row"> 
                        <label class="col-md-12 col-sm-12 col-xs-12"> 
                            <b class="col-md-4 col-sm-4 col-xs-4">Type</b>
                            <b class="col-md-4 col-sm-4 col-xs-4" >Price</b>
                            <b class="col-md-4 col-sm-4 col-xs-4">Available</b>
                        </label>
                        </li>
                        ...
                        <input class="col-md-1 col-sm-1 col-xs-1" type="radio" data-event="<?php echo $events_item['event_id'] ?>" data-ticket-class="<?php echo $events_item['ticket_class_id'] ?>" name="seat_ticket" <?php if (intval($avaialble_ticket) < 1){ echo "disabled";} ?> style="margin-right: 9px;"/>
                        <strong style="min-width: auto;"><?php echo $events_item['ticket_class_title']; ?></strong>
                        <span class="ticket-class-tooltip" data-event="<?php echo $events_item['event_id'] ?>" data-ticket-class="<?php echo $events_item['ticket_class_id'] ?>" data-ticket-class-slug="<?php echo $events_item['ticket_class_class'] ?>" >?</span>
                        </label>
                        ...
                        <label class="col-md-4  col-sm-4 col-xs-4"> 
                        <em><?php echo $avaialble_ticket;  ?></em>
                        </label>
                ...
                <div class="table-only outer-additional">
                    ...
                    <ul>
                        <li class=" row delivery"> 
                            <label class="col-md-4 col-sm-4 col-xs-4"> 
                                 <input class="col-md-1 col-sm-1 col-xs-1" type="radio" checked name="postage_type"  value="standard" style="margin-right: 9px;" />
                                 <strong>Standard</strong>
                            </label>
                            <label class="col-md-4 col-sm-4 col-xs-4"> 
                                 <input class="col-md-1 col-sm-1 col-xs-1" type="radio" name="postage_type" value="special" style="margin-right: 9px;"  />
                                 <b>Special</b>
                            </label>
                            <label class="col-md-3 col-sm-3 col-xs-3"> 
                                 <input class="col-md-1 col-sm-1 col-xs-1" type="radio" name="postage_type" value="eticket" style="margin-right: 9px;"  />
                                 <b>E-Ticket</b>
	...
	<div class="col-xs-12 bgG2">
				...
				<div class="col-xs-12 bgGG" style="height:230px;">
                    ...
                    <a href="http://facebook.com/thebrotherspromotions" target="_blank"> facebook.com/thebrotherspromotions</a><br/>
					<img src="<?=base_url()?>images/icon3.png"/>
                    <a href="http://twitter.com/mrdeanalexander" target="_blank"> @mrdeanalexander</a>
					</p>
