...
<div class="container-fluid content-bg">
	<div class="container content">
		...
		<div class="col-xs-12">
			...
			<div class="col-xs-12 table-responsive">
            	...
            	<div class="exportLink col-xs-1">
                	<a href="<?php echo base_url();?>index.php/user/exportInvitedPersonDetails/<?php echo $this->uri->segment(3); ?>"> Export</a>
                </div>
            	
            	<div class="col-xs-12">
					<table class="table table-bordered table-hover table-striped">
					<tr>
						<th><i class=" glyphicon glyphicon-envelope"></i> Name</th>
						<th><i class=" glyphicon glyphicon-envelope"></i> Contact No</th>
	...
	if($all_event){
		...
		foreach($all_event as $_row_event){
			...
			echo "<tr>";
			echo "<td>";
			if($_row_event['invited_person_name']!=''){ 
				echo $_row_event['invited_person_name'];
			}else{
				echo "N/A";	
			}
			echo "</td>";
			echo "<td>";
			if($_row_event['invited_person_contact_number']!=''){ 
				echo $_row_event['invited_person_contact_number'];
			}else{
				echo "N/A";	
			}
			echo "</td>";
