                                            ...
                                            <tbody><tr><td><u></u>
                                                    ...
                                                    <td width="500" style="color:#404040;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;text-align:left">
                                                            ...
                                                            <tbody><tr>
                                                                ...
                                                                <td width="250" valign="top" style="font-size:13px;line-height:18px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif">
                                                                    <p style="color:#404040;width:200px">
                                                                        <div class="aBn" data-term="goog_1958510381" tabindex="0"><div><b>From:</b> </div><span class="aQJ"> <?php echo date('D, M d, Y  h:i A',strtotime(($event_details['start_date'])));?></span></div><div><b>To :</b></div><div class="aBn" data-term="goog_1958510382" tabindex="0"><span class="aQJ"><?php echo date('D, M d, Y  h:i A',strtotime(($event_details['end_date'])));?></span></div>
                                                                        <div>
                                                                        	<label><b>Category:</b></label>
                                                                            <div><?php echo $event_details['category']; ?></div>
                                                                        </div>
                                                                        <div>
                                                                        	<label><b>Organizer Name:</b></label>
                                                                            <div><?php echo $event_details['organizer_name']; ?></div>
                                                                        </div>
                                                                        <div>
                                                                        	<label><b>Organizer Description:</b></label>
                                                                            <div><?php echo $event_details['organizer_description']; ?></div>
                                                                        </div>
                                                                        <div>
                                                                        	<label><b>Location:</b></label>
                                                                            <div><?php echo $event_details['venue']; ?></div>
                                                                        </div>
                                                                        <div>
                                                                        	<label><b>Details:</b></label>
                                                                            <div><?php echo $event_details['details']; ?></div>
                                                                        </div>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        ...
                                                        <div style="float:left;width : 45%; padding-bottom:20px">
                                                        	<img src="<?php echo $event_thumb; ?>"  class="img-responsive img-thumbnail" style="width:100%"/>
                                                        </div>
      ...
      <tbody><tr>
        <td>
          <table border="0" cellspacing="0" cellpadding="0" width = "100%">
            <tbody><tr>
              <td align="center" style="border-radius:5px;width:50%;" >
                  <a href="<?php echo $href;?>" style="font-size:15px; background : #8BAE42; font-weight:bold;font-family:Helvetica,Arial,sans-serif;color:#ffffff;text-decoration:none;border-radius:5px;padding:10px 18px;border:1px solid #8bae42;display:inline-block" target="_blank">
			   ...
			   <a href="<?php echo $preview;?>" style="font-size:15px; background : #8BAE42; font-weight:bold;font-family:Helvetica,Arial,sans-serif;color:#ffffff;text-decoration:none;border-radius:5px;padding:10px 18px;border:1px solid #8bae42;display:inline-block" target="_blank">
