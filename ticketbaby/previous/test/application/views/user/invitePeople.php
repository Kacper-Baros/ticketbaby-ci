<script>
	$(document).ready(function(){
		$('#inviteBtn').click(function(e){
			if($('#email').val()=='' && $('#person').val()==''){
				alert("Please type a email address Or upload a csv");
				e.preventDefault();
				return false;
			}else{
				return true;
	...
	<div class="container content">
        <div class="row no-mar main-content leftPad">
			...
			<div class="col-xs-12 ">
				...
				<form class="form-horizontal" name="form" id="" enctype="multipart/form-data" method="POST" action="<?php echo base_url();?>index.php/user/invitation">   
                        ...
                        <div class="col-xs-12">
                            <label>Upload csv to invite multiple person</label>
                            <input name="person" id="person" type="file" class="form-control" >
                        </div>
					</div>
					<div class="form-group cus-form4">
						...
						<div class="col-md-5">
							<button  type="submit" class="btn btn-block btn-warning" id="inviteBtn" name='send' value="Send">Invite Now</button>
						</div>
					</div>
				</form>
			<?php }?>
