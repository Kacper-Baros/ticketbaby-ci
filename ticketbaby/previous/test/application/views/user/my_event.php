				...
				<nav class="navbar navbar-default subNav">
                    ...
                    <div class="collapse navbar-collapse" id="subNav">
                      ...
                      <li><a href="<?php echo base_url();?>index.php/user/editProfile"><i class="glyphicon glyphicon-list-alt"></i> Account Details</a></li>
						...
						<li class="<?php if($this->router->fetch_method()=='my_event'){ echo "userActiveMenu"; } ?> " ><a href="<?php echo base_url();?>index.php/user/my_event"><i class="glyphicon glyphicon-calendar"></i> My Events</a></li>
