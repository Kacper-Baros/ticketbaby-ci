				...
				<nav class="navbar navbar-default subNav">
                    ...
                    <div class="collapse navbar-collapse" id="subNav">
                      <ul class="nav navbar-nav">
						...
						<li class="<?php if($this->router->fetch_method()=='order_detail'){ echo "userActiveMenu"; } ?> " ><a href="<?php echo base_url();?>index.php/user/order_detail"><i class="glyphicon glyphicon-tasks"></i> Order Details</a></li>
