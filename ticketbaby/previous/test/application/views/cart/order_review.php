        ...
        <?php $total_price = $total_price + $unit_price;$NUM++; } endforeach;  ?>
                ...
                <?php 
                    ...
                    for ($I=0; $I<sizeof($event_additional_charges); $I++ ) { 
						...
						//echo "<pre>";print_r($event_additional_charges );
						//echo "<pre>";print_r($views_array );die;
                    ...
                    <td>
                        ...
                        <?php 
                            if ( $event_additional_charges[$I]["additional_charge_type"] == 'P' ) { 
								...
								//echo "<pre>";
								//print_r($additional_percentage_arr);
                            }else{ 							
								...
								if(($event_additional_charges[$I]["additional_charge_field"]=='registered_postage_fee') || ($event_additional_charges[$I]["additional_charge_field"]=='special_postage_fee')){
									...
									if($postage_type=='registered_postage_fee'){ echo "checked='checked'";}
									if($method == 'order'){ echo 'disabled'; }
									echo " />";
                ...
                <?php }else{ 
                    ...
                    <tr>
                                <td></td>
									...
									if($postage_type=='special_postage_fee'){ echo "checked='checked'" ; }
									if($method == 'order'){ echo 'disabled'; }
									echo " />";
            ...
            <div class="col-xs-12 text-center bgWhite noBorders">
				...
				<?php 
				 ...
				 $subTotal = number_format(($total_price + $percentage_charge_total +  $event_additional_charge_total + $additonal_details_charity_amount + ($cart_additional_session["after_party_ticket"]["selected_tables"][0]["seat_quantity"] * 10) ),2); 
...
<script>
	...
	function addPostageFees(){
		...
		var final_number = (parseFloat(postage_type_val)+parseFloat(subTotalHidden)).toFixed(2);
