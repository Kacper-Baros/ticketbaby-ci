    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <form role="form" method="post" class="form-admin-event-creation" enctype="multipart/form-data"  action="<?=base_url()?>index.php/admin/page/edit?cms_id=<?php echo isset($cms_id) ? $cms_id : "";?>&page_start=<?php echo isset($page_start) ? $page_start : "";?>">
                    ...
                    <label>Title</label>
                    <input required class="form-control" name="cms_title" value="<?php echo isset($page_details) ? $page_details['cms_title'] : ''?>" placeholder="Enter text">
                    ...
                    <select name="category" class="category form-control" id="category" required>
						...
						?>
                        <option value="<?php echo $category['id']; ?>" <?php if($page_details['category']==$category['id']){ ?> selected="selected"
                        <?php } ?> > <?php echo $category['category_name']; ?></option>	
                        <?php } } ?>
                    </select>
                    <p class="help-block help-block-tip">The "slug" is the URL-friendly version of the name. It is usually all lowercase and contains only letters, numbers, and hyphens</p>
                    </div>
