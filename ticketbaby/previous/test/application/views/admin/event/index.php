                ...
                <div class="panel panel-default">
					...
					<form action="<?php echo base_url();?>index.php/admin/Event" method='get'>	
                        ...
                        <div class="panel-body">             
                            ...
                            <thead>
                                <tr>
                                    <th>#<input type="checkbox" name="" value="" class="selectall" id="selectall"  /></th>
                                    <th>Edit</th>
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX even gradeC">
                                    <td>
										<?=$page_start + ($i+1);?>
                                        <input type="checkbox" name="eventCheckbox" value="<?=$events[$i]["id"]?>" class="eventCheckbox" id="event-<?=$events[$i]["id"]?>" />
                                    </td>
                                    <td class="text-center">
                                    <a href="<?=base_url()?>index.php/admin/event/edit?id=<?=$events[$i]["id"]?>&page_start=<?=$page_start?>">
                                    	Edit <span class="glyphicon glyphicon-edit"></span> 
                                    </a>
                                    <a href="<?=base_url()?>index.php/admin/event/delete?eventId=<?=$events[$i]["id"]?>&userEventId=<?=$events[$i]["user_event_id"]?>&page_start=<?=$page_start?>" onclick="return cnfrm();">
                                    	Delete
                                    </a>
                                    ...
                                    <td class="text-center"><a href="<?=base_url()?>index.php/admin/ticket/event?event_id=<?=$events[$i]["id"]?>&event_page_start=<?=$page_start?>">Seat Setting<span class="glyphicon glyphicon-cog"></span></a></td>
                                    <td class="text-center"><a target="_blank" href="<?=base_url()?>index.php/event/<?=$events[$i]["slug"]?>">Preview <span class="glyphicon glyphicon-eye-open"></span> </a></td>
                                    <td class="text-center"><a target="_blank" href="<?=base_url()?>index.php/admin/event/booking/<?=$events[$i]["id"]?>"> Booking<span class="glyphicon glyphicon-list-alt"></span> </a></td>
