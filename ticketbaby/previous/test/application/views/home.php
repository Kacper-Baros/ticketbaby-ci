<div class="container-fluid content-bg">
    <div class="container content">
        ...
        <div id="adlist" class="owl-carousel" style="padding-left:25px;padding-right:25px;">
            ...
            ?>
                ...
                <div class="item"><a href="<?=base_url()?>index.php/event/<?php echo $event_item['slug'] ?>">
                    <span class="eventDate"><?php echo $event_item['start_date']; ?></span>        
                    <img src="<?=base_url()?>assets/upload/event/thumb/<?php echo $event_item['thumb1_main_carousel'] ?>" class="img-responsive" alt=""/>
                    <!--<h4 style="color:#FF8938;"><?php echo $event_item['title'] ?></h4>-->
                    </a>
                </div>          
                <?php }else{ ?>
                <div class="item">
        ...
        <div class="row form2">
            ...
            <div class="col-md-6 col-xs-12 bgOrang adpad20" style="padding-bottom:39px;">
                ...
                ?>
                    <?php if ( $event_item['ticketseatrows'] > 0 ) { ?>
                    <div class="item">
                        <a href="<?=base_url()?>index.php/event/<?php echo $event_item['slug'];?>">
                        	     
                        	<img src="<?=base_url()?>assets/upload/event/thumb/<?php echo $event_item['thumb1_recommended_carousel'] ?>" class="img-responsive" alt=""/>
                        </a>
                    </div>          
                    <?php }else{ ?>
                    <div class="item">
            ...
            <div class="col-md-3 col-xs-12 bgDark adBtmPad adpad20 addd"><br/>
                ...
                <iframe width="100%" height="171" type="text/html" src="<?php echo trim($home_page_advertisement_video[0]['video'],'"'); ?>" frameborder="0" allowfullscreen></iframe>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <img src="<?=base_url()?>assets/images/dummy-745x450.png" class="img-responsive"/><br/></center>
        </div>
        </div>
    </div>
</div> 
