...
<div class="modal fade" id="captchaSelect" role="dialog" aria-labelledby="gridSystemModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
      ...
      <div class="g-recaptcha" data-theme="light" data-sitekey="<?=$siteKey;?>"></div>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
          <button type="button" class="btn btn-primary captcha-verify-manual" id="captcha-verify">Continue</button>
        </div>
        </form>
      </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
    ...
    <div class="modal-content">
      <div class="modal-header">
          ...
          <h4 class="modal-title">
            ...
            <div class="modal-title-delivery">Delivery:</div>
      ...
      <div class="modal-body-delivery">
        <span class="modaltitle">*Test Note For Delivery</span><br>
      </div>
...
$(document).ready(function(){
	$('.captcha-verify-manual').click(function(){
		var event_promo_code = $('.event-promo-code').val();
		var postage_type = $('input[name=postage_type]:checked').val();//alert(postage_type);
		$.ajax({
				type: "POST",
				url: "<?=base_url()?>index.php/ajax/add_event_promo_code_in_session/",
				data: 'event_promo_code='+event_promo_code+'&postage_type='+postage_type,
