...
class Event extends CI_Controller {
        ...
        public function __construct()
        {
                ...
                $this->load->model(array('event_model','countries_model','states_model','cities_model'));
        }
        ...
        {   
		 ...
		 public function userpaidevent()
        {   

                $data['title'] = 'User\'s Paid Event';
                ...
                $config['total_rows']   =       $this->event_model->paid_event_record_count();
                $config['per_page']     =       10;
                $config["uri_segment"]  =       3;             
                ...
                $data['events'] = $this->event_model->get_paid_events($config["per_page"],$page);
				//echo "<pre>"; print_r($data['events']);die;
                $data['pagination_link'] = $this->pagination->create_links();
                ...
                $this->load->view('templates/admin/header', $data);
                $this->load->view('admin/event/userpaidevent', $data);
                $this->load->view('templates/admin/footer');
        }
        ...
        public function edit()
        {
				...
				$comingfrom     = ($this->input->get('comingfrom')) ? $this->input->get('comingfrom') : '';
                ...
                if ( !isset($event_id) || $event_id < 1 ) {
                        ...
                        $data['event_details']              =  $this->event_model->get_event_by_id ($event_id,$comingfrom);
		...
		public function delete(){
			...
			$RESPONSE   = $this->event_model->deleteEvent ($formValues);
