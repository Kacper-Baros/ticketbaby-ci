...
class Music extends CI_Controller {
        ...
        public function __construct()
        {
				...
				$this->load->model('category_event_model');	
        ...
        {	
			...
			//echo "<pre>";print_r($data_catge);die;
			...
			$datas['home_page_event_list']						=	$data['home_page_event_list'];
			$data['getEventIdsByCategoryId'] 		= 	$this->category_event_model->getEventIdsByCategoryId($data_catge['cat_id']);
