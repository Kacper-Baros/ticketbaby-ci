...
class BarclaycardEpdq {
	...
	// account no / PSPID
	public $mPSPID = 'epdq1096753'; //'aneesh';
	// SHA-IN pass phrase
	public $mPassword = 'ABCDEFG-12345678@';
	...
	public $mCurrency = 'GBP';
	public $mLanguage = 'en_US';

	public $mGenerateHash = false;
	public $mFormParams = array();
	
	public $mFailReason = false;
	
	public $mNotificationEmails = array('admin@tBaby.com');
