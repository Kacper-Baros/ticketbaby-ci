...
! function(a) {
    ...
    TBABY.init = function(a) {
        ...
        hideAllTooltipContent: function() {
            a("#ticketClassTooltip .modal-title-standard").hide(), a("#ticketClassTooltip .modal-title-premium").hide(), a("#ticketClassTooltip .modal-title-gold").hide(), a("#ticketClassTooltip .modal-title-vip").hide(), a("#ticketClassTooltip .modal-title-afterparty").hide(), a("#ticketClassTooltip .modal-title-afterpartyticket").hide(), a("#ticketClassTooltip .modal-title-delivery").hide(), a("#ticketClassTooltip .modal-body-standard").hide(), a("#ticketClassTooltip .modal-body-premium").hide(), a("#ticketClassTooltip .modal-body-gold").hide(), a("#ticketClassTooltip .modal-body-vip").hide(), a("#ticketClassTooltip .modal-body-afterparty").hide(), a("#ticketClassTooltip .modal-body-afterpartyticket").hide(), a("#ticketClassTooltip .modal-body-delivery").hide()
        },
        ...
        a('button[name="btn-hot-ticket-tab"]').click(function() {
            ...
            if ("vvip-platinum" == b || "vip-platinum" == b) a("#ticketClassTooltip .modal-title-vip").show(), a("#ticketClassTooltip .modal-body-vip").show();
			 ...
			 else if ("delivery" == b) a("#ticketClassTooltip .modal-title-delivery").show(), a("#ticketClassTooltip .modal-body-delivery").show();
