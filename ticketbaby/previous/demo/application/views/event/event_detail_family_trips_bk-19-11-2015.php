		 ...
		 <div class="col-xs-12">
				...
				<div class="event-info col-xs-12 ">
					...
					<div class="col-md-6 col-xs-12"><br/>
						<div class="col-md-4 col-xs-12 orang-bk text-center">
					...
					<div class="col-md-0 col-xs-12 cm-table-box cus-selectx cus-ick">
                    ...
                    <ul>         
                        ...
                        <input type="text" autocomplete="off" placeholder="Promo Code"  value="<?php echo ($cart_captcha_session && $cart_captcha_session["event_customer_details"]) ? $cart_captcha_session["event_customer_details"]["customer_promo_code"] : ""; ?>" id="customer_promo_code_id"  class="event-promo-code" name="customer_promo_code">
                        </li>
                    </ul>
