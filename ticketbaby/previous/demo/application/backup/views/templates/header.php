                ...
                <nav class="navbar navbar-inverse">
                    ...
                    <div class="collapse custom-navigation navbar-collapse main-menu navbar-right no-pad" id="myNavbar">
                      <ul class="nav navbar-nav">
                        ...
                        <li><a href="#">Music</a>
						<ul class="submenu">
						<li><a href="<?=base_url()?>index.php/Music/Music">Clubnites</a></li>
						<li><a href="<?=base_url()?>index.php/event/southport-family-day-trip">Concerts</a></li>
						<li><a href="<?=base_url()?>index.php/event/southport-family-day-trip">Music Festivals (keep this as an option now)</a></li>
						</ul>
						</li>
                        <li><a href="<?=base_url()?>index.php/event/movie-video-and-screen-awards">Galas & Awards</a></li>
                        <li><a href="#">Theatre & Arts</a>
						<ul class="submenu">
						<li><a href="<?=base_url()?>index.php/event/southport-family-day-trip">Comedy</a></li>
						<li><a href="<?=base_url()?>index.php/event/southport-family-day-trip">Plays</a></li>
						<li><a href="<?=base_url()?>index.php/event/southport-family-day-trip">Shows (Keep this as an option now)</a></li>
						</ul>
