...
class User extends CI_Controller {
        ...
        {   
                ...
                $config['base_url']     =       base_url() .  ($this->config->item('index_page') ? $this->config->item('index_page') . "/" : "")  . '/admin/user/';
                ...
                $data['users'] = $this->user_model->get_users(FALSE,$config["per_page"],$page);
