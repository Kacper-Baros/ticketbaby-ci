                ...
                <nav class="navbar navbar-inverse">
                    ...
                    <div class="collapse custom-navigation navbar-collapse main-menu navbar-right no-pad" id="myNavbar">
                      <ul class="nav navbar-nav">
                        ...
                        <li><a href="#">Music</a>
						<ul class="submenu">
						<li><a href="<?=base_url()?>index.php/event/club-nite">Clubnites</a></li>
						<li><a href="<?=base_url()?>index.php/music/Concerts">Concerts</a></li>
						<li><a href="<?=base_url()?>index.php/music/Music-festival">Music Festivals (keep this as an option now)</a></li>
						</ul>
						</li>
