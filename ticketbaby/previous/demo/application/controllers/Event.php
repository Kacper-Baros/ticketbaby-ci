		...
		if ($this->user_details->loggedin() == FALSE)
         ...
         if($this->input->post('Save') )
		   {	
				...
				$img_extension_main_carousel   = $this->input->post('img_extension_main_carousel');
				
				
				
			$response = $this->event_model->createUserEventPaid(array(
			...
			'img_extension_main_carousel' => $img_extension_main_carousel));
