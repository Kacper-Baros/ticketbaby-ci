                    ...
                    <div class="table-only">
                        ...
                        <ul>
                            ...
                            foreach ($event_seats as $events_item): if ($events_item['ticket_section_section'] == "table" && $events_item['ticket_group'] == "default") {
                                    ...
                                    <li class="row">
									    <label class="col-md-12 col-sm-12 col-xs-12"> 
										<strong class="col-md-6 col-sm-6 col-xs-6 text-lefts">
                                        <input class="radiotype" type="radio" data-event="<?php echo $events_item['event_id'] ?>" data-ticket-class="<?php echo $events_item['ticket_class_id'] ?>"  name="seat_table" <?php
                                        ...
                                        ?>/>
                                            ...
                                            <span class="ticket-class-tooltip" data-event="<?php echo $events_item['event_id'] ?>" data-ticket-class="<?php echo $events_item['ticket_class_id'] ?>" data-ticket-class-slug="<?php echo $events_item['ticket_class_class'] ?>" >?</span></strong>
                                            <strong class="col-md-3 col-sm-3 col-xs-3" ><em class="prices">&pound; <?php echo $events_item['unit_price'] * $events_item['unit_min_purchase']; ?></em></strong>
                                            <strong class="col-md-3 col-sm-3 col-xs-3 text-right"><?php if($events_item['ticket_class_id']=="2"  ) { 
											if(empty($avaialble_table)){
											echo $avaialble_table;
						
											}
											else{
											echo $avaialble_table+1;	
											}
											} 
											else { echo $avaialble_table ;}?></strong>
                        ...
                        <ul>
                            ...
                            foreach ($event_seats as $events_item): if ($events_item['ticket_section_section'] == "ticket" && $events_item['ticket_group'] == "default") {
                                    ...
                                    <li class="row">
									    <label class="col-md-12 col-sm-12 col-xs-12"> 
										<strong class="col-md-6 col-sm-6 col-xs-6 text-lefts">
                                        <input class="radiotype" type="radio" data-event="<?php echo $events_item['event_id'] ?>" data-ticket-class="<?php echo $events_item['ticket_class_id'] ?>" name="seat_ticket" <?php
                                        ...
                                        ?>/>
                                            ...
                                            <strong><?php echo $events_item['ticket_class_title']; ?></strong>
                                            <span class="ticket-class-tooltip" data-event="<?php echo $events_item['event_id'] ?>" data-ticket-class="<?php echo $events_item['ticket_class_id'] ?>" data-ticket-class-slug="<?php echo $events_item['ticket_class_class'] ?>" >?</span></strong>
                                            <strong class="col-md-3 col-sm-3 col-xs-3" ><em class="em-price prices"> &pound; <?php echo $events_item['unit_price'] * $events_item['unit_min_purchase']; ?></em></strong>
                                            <strong class="col-md-3 col-sm-3 col-xs-3 text-right"><?php echo $avaialble_ticket; ?></strong>                                            
                        ...
                        <ul>
                            ...
                            foreach ($event_seats as $events_item):
                                if ($events_item['ticket_group'] == "additional") {
                                    ...
                                    <li class="row"> 
                                         <label class="col-md-12 col-sm-12 col-xs-12"> 									
                                        <strong class="col-md-6 col-sm-6 col-xs-6 text-lefts"><input class="radiotype" type="radio" name="after_party_ticket_select" <?php
                                        if (intval($avaialble_ticket) < 1) {
                                            echo "disabled";
                                        }
                                        ?> />
                                            ...
                                            <strong><?php echo $events_item['ticket_class_title']; ?></strong>
                                            <span class="ticket-class-tooltip" data-event="<?php echo $events_item['event_id'] ?>" 
                                            data-ticket-class="<?php echo $events_item['ticket_class_id'] ?>" data-ticket-class-slug="<?php echo $events_item['ticket_class_class'] ?>" >?</span></strong>
                                            <strong class="col-md-3 col-sm-3 col-xs-3" ><em class="em-price-additional prices">&pound; <?php echo $events_item['unit_price'] * $events_item['unit_min_purchase']; ?></em></strong>
                                            <?php
                                            for ($I = $events_item["table_start_number"]; $I <= $events_item["table_end_number"]; $I++) {
                                                $available_seat_count = $events_item["table_seat_count"];
                                                ?>
                                                <strong class="col-md-3 col-sm-3 col-xs-3 text-right"><select min="1" max="<?= $available_seat_count; ?>" name="choose-ticket-quantity-<?= $I; ?>" id="choose-additional-ticket"
                ...
                <div class="col-xs-12 bgG2">
                    <div class="col-xs-12 bgGG">
                        ...
                        <div class="col-xs-12" style="height:255px;"><br/>
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2430.0130192453153!2d-1.9124796841940837!3d52.47889997980663!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4870bc8c8cd2ec93%3A0xea3880348237a86f!2sThe+International+Convention+Centre!5e0!3m2!1sen!2suk!4v1469159230114" width="100%" height="250" frameborder="0" style="border:0" allowfullscreen></iframe>
                        </div>
