<div class="container-fluid content-bg">
    ...
    <div class="container">
        <div class="row form2">
		 ...
		 <a class="left carousel-control" href="#myCarousel" data-slide="prev" style="margin:50px 0 0 50px;">‹</a>
		
		<div id="shortcarousel">
                ...
                <a class="right carousel-control" href="#myCarousel" data-slide="prev" style="margin:46px 88px 0px  0px;">›</a>
                 <br/>
            </div>
    ...
    <div class="container">
        ...
        <img src="<?=base_url()?>assets/images/family.png" class="img-responsive" /><br/></center>
        </div>
        </div>

		 <div class="row"> 
	<div class="col-md-9 " style="background-image:url('<?=base_url()?>assets/images/event-bg.png');     background-repeat: round;">
				<div id="image-background" >
                                   <h1> Create Your Own Event </h1>
	       <p>Bring People Together or turn your Passion into a Business<br/>Event Brite Give to Everthing to host Your Best Event Yet </p>
			 <h3>GET STARTED NOW! </h3>
                                 </div>
	                 </div>
			<div class="col-md-3  bgDark adpad20">
