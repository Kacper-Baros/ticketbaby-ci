...
<input type="text" placeholder="    Enter an address, zip code or city..." name="q" value="<?php echo $q;?>" style="width:40%; height:34px;" />
            <input type="submit" value="Search" name="result" class='search_submit' style="width:22%; height:35px;"/>
