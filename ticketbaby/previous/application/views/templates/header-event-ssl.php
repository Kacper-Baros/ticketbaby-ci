                    ...
                    <link rel="stylesheet" href="<?= $base_url ?>assets/bootstrapvalidator/bootstrapValidator.min.css">
                        ...
                        <link rel="stylesheet" href="<?= $base_url ?>assets/css/style.min.css">
                            <link rel="stylesheet" href="<?= $base_url ?>css/style.css">
                                ...
                                <body>
                                    <div class="container-fluid orange-strip cusmo">
                                                ...
                                                <nav class="navbar navbar-inverse">
                                                    ...
                                                    <div class="collapse navbar-collapse navbar-right main-menu no-pad" id="myNavbar">
                                                        <ul class="nav navbar-nav">
                                                            ...
                                                            <li class="dropdown">
                                                                <a data-toggle="dropdown" class="dropdown-toggle" href="javascript:void(0);">Music <b class="caret"></b></a>
                                    ...
                                    <div class="container-fluid search-bar">
                                        <div class="container">
                                            ...
                                            <div class="col-md-2 col-sm-3 col-md-offset-2 col-xs-12 barclay mobilenone">
                                                <img src="<?= $base_url ?>assets/images/barclay.png" class="col-md-offset-7"/>
                                            </div> 
