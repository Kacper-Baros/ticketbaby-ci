...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		 ...
		 *  @type function
		 *  @param {object} settings DataTables settings object
		 *  @param {object} data The state object to be saved��	 *�&��k�|cF�-��ǘ����֘l��	 j��9,����OataTable.defaults.stateSaveParams
		 *
		 *  @example
		 ...
		 *    } );
		 */
		"fnStat�j`veParams": null,
	
	
		/**
		 * Duration�for which the sa���ate i^�L��n�ɍ�������ȯ��#�n�b�!Z������	W��!�}:����,5 	����C�HǦ��-!vW���F��3��*J'CLR]���z3u��c�,6W���T��)7i�K�	~��s�n��Y���o�P����� �s�rRC} ׼f�
HqS��~�X�\�����y�U1�I��!���^>_ծs��]���n0�� �� 8 ''���x��2�t� =��!L��.��a�� 0Iy�.z�3?4�1�n�,0:s~�~s�S���<���\���V�vG�S�覀��/�}p���ŕP������rW/�).ready( function() {
		 *      $('#example').dataTable( {
