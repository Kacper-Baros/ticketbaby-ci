...
class Ajax extends CI_Controller {
    ...
    public function setSessionCart() {
        ...
        if ($this->input->post('charge_type') == 'delivery') {
            $this->session->set_userdata('cart_delivery_type', $this->input->post('delivery_type'));
        } else {
            ...
            $table_numbers = $this->input->post('choose-table-number', 0);
            ...
            if ($this->input->post('ticket_group') == 'additional') {
                $selected_tables[0]["table_number"] = 0;
                $selected_tables[0]["seat_quantity"] = intval($this->input->post('choose_ticket_quantity'));
            } else {
