                        ...
                        <div class="panel-body">             
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX even gradeC">
                                    ...
                                    <td class="text-center"><a href="<?=base_url()?>index.php/admin/event/edit?id=<?=$events[$i]["id"]?>&page_start=<?=$page_start?>">Edit <span class="glyphicon glyphicon-edit"></span> </a></td>    
